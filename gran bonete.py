def dibujo(caracter,rango):
    ...
    for fila in range (rango):
        for columna in range(rango):
            if(fila <= ran /2  and columna + fila >= ran /2  and  columna <= ran /2 + fila  or columna ==0 and  fila > ran /2 and columna <= ran /2  or columna == ran and fila > ran/2 or fila == ran /2 or fila == ran):
